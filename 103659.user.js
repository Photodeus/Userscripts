...
if (typeof SOUND_FILES.alliancereport == 'undefined') {
	SOUND_FILES.alliancereport = { };
	SOUND_FILES.alliancereport.OGG = 'data:audio/ogg;base64,' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'' +
		'PZOpK78ZgK0RLgAEEIBcGP0ZTOU2Sja7HE7N7jios83ntvmkhnX9o3Ou23mO8r6/LQI0OX/wnbnzxz8JJBnENh4/Dl7tpu3DJ4CAAMxxtzLRryrf1kYijKSlRrx/nTj0/lx3Gw==';
	SOUND_FILES.alliancereport.DEFAULT = '<audio autoplay="autoplay" id="html5audioplayer"><source src="'+SOUND_FILES.alliancereport.OGG+'" type="audio/ogg" /></audio>';
}
...
var ChatStuff = {
 ...
 chatDivContentHook : function (msg,type){
	...
	if (scripters.indexOf(suid) >= 0) {
     ...
     if(alliance){
		 if (whisp.indexOf('My embassy has') >= 0 && whisp.indexOf('Do not attempt to reinforce') == -1.&& Options.enableTowerAlert) {
		 ...
		 if (whisp.indexOf('member of the alliance has been attacked') >= 0 && Options.enableTowerAlert) {
			AudioManager.setSource(SOUND_FILES.alliancereport);
			AudioManager.play();
			setTimeout(function(){AudioManager.play();}, 120);
			setTimeout(function(){AudioManager.play();}, 250);
			setTimeout(function(){AudioManager.stop();}, 3000);
		 }
     }
     return msg;
   },
	...
	ReportPopup: function (rslt, rpt, reportId) {
		...
		function handleunts() { // Troops sent to Reinforce or troops found on a Scout
		    ...
		    if (rslt['unts'] != undefined) {
		        if (rpt.marchName == 'Reinforce') th = '<TABLE class=ptTab><TR><TH colspan=3 align=left>Troops Reinforced</TH></TR>';
		        else if (rslt['unts']['u1'] != undefined || rslt['unts']['u2'] != undefined || rslt['unts']['u3'] != undefined || rslt['unts']['u4'] != undefined || rslt['unts']['u5'] != undefined || rslt['unts']['u6'] != undefined || rslt['unts']['u7'] != undefined || rslt['unts']['u8'] != undefined || rslt['unts']['u9'] != undefined || rslt['unts']['u10'] != undefined || rslt['unts']['u11'] != undefined || rslt['unts']['u12'] != undefined) th = '<TABLE class=ptTab><TR><TH colspan=3 align=left>Troops Found</TH></TR>';
		        for (var i = 1; i < 13; i++)
		        if (rslt['unts']['u' + i] != undefined) tc += '<TR><TD>' + unitImg[i] + '</TD><TD align=right>' + addCommas(rslt['unts']['u' + i]) + '</TD></TR>';
		        tf = '</TABLE>';
		    }
		    if (tc != '') hunts = th + tc + tf;
		    return hunts;
		}
     ...
     if(rslt.type==24){
      ...
      t.cont.innerHTML += tournyhtml.join("");      
           document.getElementById('BOTournoiPM').addEventListener ('click', function() { 
            ...
            if (rslt.type!=124) lg=125;
            t.plusmoins(lg);
           }, false);      
           
        if ((Options.TournoiLigne==5 && rslt.type!=124) || (Options.TournoiLigne==5 && rslt.type==124)) {
